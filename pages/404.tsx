...
import { CollectionGetResponse, DataItem, LocaleTypeAttributes, Page404Attributes, SinglePageResponse, WebsiteAttributes } from "lib/api/api";
import { fetchAPI } from "lib/api/client";
import { populate } from "lib/api/utils";
import { getAvailableLocalesTypeList } from "lib/i18n";
import { GetStaticProps, InferGetStaticPropsType } from "next";

function Page404({ page, global, locales }: InferGetStaticPropsType<typeof getStaticProps>) {
    return (
      <>    
  ...
  export const getStaticProps: GetStaticProps<{
    ...
    const [ global, pageData ] = await Promise.all<[Promise<CollectionGetResponse<WebsiteAttributes>>, Promise<SinglePageResponse<Page404Attributes>> ]>([
      ...
      fetchAPI("/page404", { locale, populate: ['localizations', ...populate.seo] })
    ])
